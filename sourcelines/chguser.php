...
?>
<td align=right><?php echo $t->translate("Last modified") ?>:</td><td><?php echo timestr($time); ?></td></tr>
<tr>
<?php
	$time = mktimestamp($db->f("creation_usr"));
?>
<td align=right><?php echo $t->translate("Created") ?>:</td><td><?php echo timestr($time); ?></td></tr>
<tr>
